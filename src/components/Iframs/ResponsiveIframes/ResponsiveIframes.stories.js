...
import ResponsiveIframesPropTable from "./ResponsiveIframesPropTable.md";
...
storiesOf("Components/Iframs/ResponsiveIframes", module)
  .addParameters({
    zeplinLink: "",
    readme: {
      codeTheme: "atom-dark",
      sidebar: [README, ResponsiveIframesPropTable],
