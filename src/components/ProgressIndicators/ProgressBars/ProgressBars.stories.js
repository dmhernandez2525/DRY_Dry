        ...
        import ProgressBarsPropTable from "./ProgressBarsPropTable.md";
        ...
        storiesOf("Components/ProgressIndicators/ProgressBars", module)
        .addParameters({
          zeplinLink:
            "",
          readme: {
            codeTheme: "atom-dark",
            sidebar: [README, ProgressBarsPropTable],
