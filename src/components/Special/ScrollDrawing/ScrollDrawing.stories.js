        ...
        import ScrollDrawingPropTable from "./ScrollDrawingPropTable.md";
        ...
        storiesOf("Components/Special/ScrollDrawing", module)
        .addParameters({
          zeplinLink:
            "",
          readme: {
            codeTheme: "atom-dark",
            sidebar: [README, ScrollDrawingPropTable],
