        ...
        import GradientBgScrollPropTable from "./GradientBgScrollPropTable.md";
        ...
        storiesOf("Components/Special/GradientBgScroll", module)
        .addParameters({
          zeplinLink:
            "",
          readme: {
            codeTheme: "atom-dark",
            sidebar: [README, GradientBgScrollPropTable],
