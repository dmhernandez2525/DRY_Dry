        ...
        import DraggableHTMLElementPropTable from "./DraggableHTMLElementPropTable.md";
        ...
        storiesOf("Components/Special/DraggableHTMLElement", module)
        .addParameters({
          zeplinLink:
            "",
          readme: {
            codeTheme: "atom-dark",
            sidebar: [README, DraggableHTMLElementPropTable],
