...
import ChangeBgonScrollPropTable from "./ChangeBgonScrollPropTable.md";
...
storiesOf("Components/Images/ChangeBgonScroll", module)
  .addParameters({
    zeplinLink: "",
    readme: {
      codeTheme: "atom-dark",
      sidebar: [README, ChangeBgonScrollPropTable],
