...
import BlurBackgroundImagePropTable from "./BlurBackgroundImagePropTable.md";
...
storiesOf("Components/Images/BlurBackgroundImage", module)
  .addParameters({
    zeplinLink: "",
    readme: {
      codeTheme: "atom-dark",
      sidebar: [README, BlurBackgroundImagePropTable],
