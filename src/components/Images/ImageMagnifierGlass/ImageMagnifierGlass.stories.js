...
import ImageMagnifierGlassPropTable from "./ImageMagnifierGlassPropTable.md";
...
storiesOf("Components/Images/ImageMagnifierGlass", module)
  .addParameters({
    zeplinLink: "",
    readme: {
      codeTheme: "atom-dark",
      sidebar: [README, ImageMagnifierGlassPropTable],
