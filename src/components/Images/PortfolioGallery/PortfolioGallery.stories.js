...
import PortfolioGalleryPropTable from "./PortfolioGalleryPropTable.md";
...
storiesOf("Components/Images/PortfolioGallery", module)
  .addParameters({
    zeplinLink: "",
    readme: {
      codeTheme: "atom-dark",
      sidebar: [README, PortfolioGalleryPropTable],
