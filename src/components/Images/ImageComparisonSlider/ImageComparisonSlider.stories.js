...
import ImageComparisonSliderPropTable from "./ImageComparisonSliderPropTable.md";
...
storiesOf("Components/Images/ImageComparisonSlider", module)
  .addParameters({
    zeplinLink: "",
    readme: {
      codeTheme: "atom-dark",
      sidebar: [README, ImageComparisonSliderPropTable],
