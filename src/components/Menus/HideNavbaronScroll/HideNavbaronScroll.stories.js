        ...
        import HideNavbaronScrollPropTable from "./HideNavbaronScrollPropTable.md";
        ...
        storiesOf("Components/Menus/HideNavbaronScroll", module)
        .addParameters({
          zeplinLink:
            "",
          readme: {
            codeTheme: "atom-dark",
            sidebar: [README, HideNavbaronScrollPropTable],
