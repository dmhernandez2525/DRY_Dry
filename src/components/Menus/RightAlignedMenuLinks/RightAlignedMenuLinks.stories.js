        ...
        import RightAlignedMenuLinksPropTable from "./RightAlignedMenuLinksPropTable.md";
        ...
        storiesOf("Components/Menus/RightAlignedMenuLinks", module)
        .addParameters({
          zeplinLink:
            "",
          readme: {
            codeTheme: "atom-dark",
            sidebar: [README, RightAlignedMenuLinksPropTable],
