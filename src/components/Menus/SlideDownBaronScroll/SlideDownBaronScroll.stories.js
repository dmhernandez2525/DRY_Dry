        ...
        import SlideDownBaronScrollPropTable from "./SlideDownBaronScrollPropTable.md";
        ...
        storiesOf("Components/Menus/SlideDownBaronScroll", module)
        .addParameters({
          zeplinLink:
            "",
          readme: {
            codeTheme: "atom-dark",
            sidebar: [README, SlideDownBaronScrollPropTable],
