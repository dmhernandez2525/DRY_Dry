        ...
        import HoverDropdownsPropTable from "./HoverDropdownsPropTable.md";
        ...
        storiesOf("Components/Menus/HoverDropdowns", module)
        .addParameters({
          zeplinLink:
            "",
          readme: {
            codeTheme: "atom-dark",
            sidebar: [README, HoverDropdownsPropTable],
