        ...
        import SidebarwithIconsPropTable from "./SidebarwithIconsPropTable.md";
        ...
        storiesOf("Components/Menus/SidebarwithIcons", module)
        .addParameters({
          zeplinLink:
            "",
          readme: {
            codeTheme: "atom-dark",
            sidebar: [README, SidebarwithIconsPropTable],
