        ...
        import VerticalButtonGroupPropTable from "./VerticalButtonGroupPropTable.md";
        ...
        storiesOf("Components/Menus/VerticalButtonGroup", module)
        .addParameters({
          zeplinLink:
            "",
          readme: {
            codeTheme: "atom-dark",
            sidebar: [README, VerticalButtonGroupPropTable],
