        ...
        import ShrinkNavbaronScrollPropTable from "./ShrinkNavbaronScrollPropTable.md";
        ...
        storiesOf("Components/Menus/ShrinkNavbaronScroll", module)
        .addParameters({
          zeplinLink:
            "",
          readme: {
            codeTheme: "atom-dark",
            sidebar: [README, ShrinkNavbaronScrollPropTable],
