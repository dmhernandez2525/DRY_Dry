        ...
        import ResponsiveTopnavPropTable from "./ResponsiveTopnavPropTable.md";
        ...
        storiesOf("Components/Menus/ResponsiveTopnav", module)
        .addParameters({
          zeplinLink:
            "",
          readme: {
            codeTheme: "atom-dark",
            sidebar: [README, ResponsiveTopnavPropTable],
