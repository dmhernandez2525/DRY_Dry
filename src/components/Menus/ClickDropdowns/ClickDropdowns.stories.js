        ...
        import ClickDropdownsPropTable from "./ClickDropdownsPropTable.md";
        ...
        storiesOf("Components/Menus/ClickDropdowns", module)
        .addParameters({
          zeplinLink:
            "",
          readme: {
            codeTheme: "atom-dark",
            sidebar: [README, ClickDropdownsPropTable],
