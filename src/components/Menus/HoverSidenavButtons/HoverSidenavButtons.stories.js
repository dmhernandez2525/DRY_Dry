        ...
        import HoverSidenavButtonsPropTable from "./HoverSidenavButtonsPropTable.md";
        ...
        storiesOf("Components/Menus/HoverSidenavButtons", module)
        .addParameters({
          zeplinLink:
            "",
          readme: {
            codeTheme: "atom-dark",
            sidebar: [README, HoverSidenavButtonsPropTable],
