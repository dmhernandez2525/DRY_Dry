        ...
        import CollapsedSidebarPropTable from "./CollapsedSidebarPropTable.md";
        ...
        storiesOf("Components/Menus/CollapsedSidebar", module)
        .addParameters({
          zeplinLink:
            "",
          readme: {
            codeTheme: "atom-dark",
            sidebar: [README, CollapsedSidebarPropTable],
