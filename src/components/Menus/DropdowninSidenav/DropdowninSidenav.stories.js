        ...
        import DropdowninSidenavPropTable from "./DropdowninSidenavPropTable.md";
        ...
        storiesOf("Components/Menus/DropdowninSidenav", module)
        .addParameters({
          zeplinLink:
            "",
          readme: {
            codeTheme: "atom-dark",
            sidebar: [README, DropdowninSidenavPropTable],
