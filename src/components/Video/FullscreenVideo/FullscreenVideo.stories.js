...
import FullscreenVideoPropTable from "./FullscreenVideoPropTable.md";
...
storiesOf("Components/Video/FullscreenVideo", module)
  .addParameters({
    zeplinLink: "",
    readme: {
      codeTheme: "atom-dark",
      sidebar: [README, FullscreenVideoPropTable],
