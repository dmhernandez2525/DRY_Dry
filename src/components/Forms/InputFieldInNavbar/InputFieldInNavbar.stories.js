...
import InputFieldInNavbarPropTable from "./InputFieldInNavbarPropTable.md";
...
storiesOf("Components/Forms/InputFieldInNavbar", module)
  .addParameters({
    zeplinLink: "",
    readme: {
      codeTheme: "atom-dark",
      sidebar: [README, InputFieldInNavbarPropTable],
