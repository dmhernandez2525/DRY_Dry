...
import PasswordValidationPropTable from "./PasswordValidationPropTable.md";
...
storiesOf("Components/Forms/PasswordValidation", module)
  .addParameters({
    zeplinLink: "",
    readme: {
      codeTheme: "atom-dark",
      sidebar: [README, PasswordValidationPropTable],
