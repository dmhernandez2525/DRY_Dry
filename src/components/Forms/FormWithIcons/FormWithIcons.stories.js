        ...
        import FormWithIconsPropTable from "./FormWithIconsPropTable.md";
        ...
        storiesOf("Components/Forms/FormWithIcons", module)
        .addParameters({
          zeplinLink:
            "",
          readme: {
            codeTheme: "atom-dark",
            sidebar: [README, FormWithIconsPropTable],
